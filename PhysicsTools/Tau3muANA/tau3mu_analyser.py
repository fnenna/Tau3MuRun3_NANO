...
def process_tau3mu_events(sub_df, isMC):
    ...
    # Ora uniamo tutto (assumendo che i casi siano mutuamente esclusivi per evento)
    # Inizializziamo con dei valori dummy (es. 0)
    ...
    sorted = dak.argsort(sub_df["Tau3Mu_chi2"])
    for col in selected_fields:
...
def Analysis_Tau3Mu(tree, dataset_name, output_path, era, stream):
    '''
