...
config.General.requestName = 'SkimCHANNELNAME_YEAReraERANAME_streamNUMBER_Mini_v4'
...
config.Data.outputDatasetTag = 'SkimCHANNELNAME_YEAReraERANAME_streamNUMBER_Mini_v4'
