...
config.General.requestName = 'SkimDsPhiPi_2024eraB_stream5_Mini_v4'
...
config.Data.inputDataset = '/ParkingDoubleMuonLowMass5/Run2024B-PromptReco-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'SkimDsPhiPi_2024eraB_stream5_Mini_v4'
